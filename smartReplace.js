...
//         await download("https://github.com/allindusk/codebackup_ym/raw/laobanb/jdCookie.js", "./jdCookie.js", "京东Cookies");
    if (remoteContent.indexOf("jdFruitShareCodes") > 0) {
        await download(
            "https://github.com/allindusk/codebackup_ym/raw/laobanb/jdFruitShareCodes.js",
    ...
    if (remoteContent.indexOf("jdPetShareCodes") > 0) {
        await download(
            "https://github.com/allindusk/codebackup_ym/raw/laobanb/jdPetShareCodes.js",
            "./jdPetShareCodes.js",
            "京东萌宠"
        );
    }
    if (remoteContent.indexOf("jdPlantBeanShareCodes") > 0) {
        await download(
            "https://github.com/allindusk/codebackup_ym/raw/laobanb/jdPlantBeanShareCodes.js",
    ...
    if (remoteContent.indexOf("jdSuperMarketShareCodes") > 0)
        await download(
            "https://github.com/allindusk/codebackup_ym/raw/laobanb/jdSuperMarketShareCodes.js",
            "./jdSuperMarketShareCodes.js",
            "京小超互助码"
        );
    if (remoteContent.indexOf("jdFactoryShareCodes") > 0) {
        await download(
            "https://github.com/allindusk/codebackup_ym/raw/laobanb/jdFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("jdDreamFactoryShareCodes") > 0) {
        await download(
            "https://github.com/allindusk/codebackup_ym/raw/laobanb/jdDreamFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("new Env('京喜农场')") > 0) {
        await download(
            "https://github.com/allindusk/codebackup_ym/raw/laobanb/jdJxncTokens.js",
            "./jdJxncTokens.js",
            "京喜农场Token"
        );
        await download(
            "https://github.com/allindusk/codebackup_ym/raw/laobanb/jdJxncShareCodes.js",
            "./jdJxncShareCodes.js",
            "京喜农场分享码"
        );
        await download(
            "https://github.com/allindusk/codebackup_ym/raw/laobanb/USER_AGENTS.js",
            "./USER_AGENTS.js",
            "USER_AGENTS"
        );
    }
...
async function downloader_notify() {
    await download("https://github.com/allindusk/codebackup_ym/raw/laobanb/sendNotify.js", "./sendNotify.js", "统一通知");
}

async function downloader_user_agents() {
    await download("https://github.com/allindusk/codebackup_ym/raw/laobanb/USER_AGENTS.js", "./USER_AGENTS.js", "云端UA");
}
